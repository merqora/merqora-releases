...
data class OrderDB(
    ...
    @SerialName("mp_application_fee") val mpApplicationFee: Double? = null,
    @SerialName("mp_sponsor_id") val mpSponsorId: String? = null,
    @SerialName("split_info") val splitInfo: kotlinx.serialization.json.JsonObject? = null,
    @SerialName("commission_percentage") val commissionPercentage: Double? = null,
    @SerialName("commission_amount") val commissionAmount: Double? = null,
    @SerialName("seller_net_amount") val sellerNetAmount: Double? = null,
...
data class PaymentDB(
    ...
    @SerialName("mp_fee_details") val mpFeeDetails: kotlinx.serialization.json.JsonArray? = null,
    @SerialName("mp_net_received_amount") val mpNetReceivedAmount: Double? = null,
    @SerialName("mp_commission_amount") val mpCommissionAmount: Double? = null,
    @SerialName("mp_financial_status") val mpFinancialStatus: String? = null,
    @SerialName("payment_method_type") val paymentMethodType: String? = null,
    @SerialName("installments_count") val installmentsCount: Int? = null
)
...
data class Order(
    ...
    val splitInfo: Map<String, Any>? = null,
    val commissionAmount: Double = 0.0,
    val sellerNetAmount: Double = 0.0
) {
    ...
    companion object {
        fun fromDB(db: OrderDB, items: List<OrderItem> = emptyList(), payment: Payment? = null): Order {
            return Order(
                ...
                splitInfo = db.splitInfo?.let {
                    try {
                        kotlinx.serialization.json.Json { ignoreUnknownKeys = true }
                            .decodeFromString<Map<String, Any>>(it.toString())
                    } catch (_: Exception) { null }
                },
                commissionAmount = db.commissionAmount ?: 0.0,
                sellerNetAmount = db.sellerNetAmount ?: 0.0
            )
        }
    }
}
