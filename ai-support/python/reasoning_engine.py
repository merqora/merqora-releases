...
- Mercora's features and policies
"""
...
class MercoraKnowledge:
    """Core knowledge about Mercora platform"""
...
class ReasoningEngine:
    ...
    Uses pattern matching, template generation, and Mercora knowledge.
    """
    
    def __init__(self):
        self.knowledge = MercoraKnowledge()
...
💡 Tienes **{self.knowledge.POLICIES["return_window"]}** para reportar. Mercora protege todas tus compras."""
...
🔒 Tus datos de pago están protegidos con encriptación de grado bancario."""
            ...
            response = f"""En Mercora aceptamos varios métodos de pago:

💳 **Tarjetas:** Visa, Mastercard, American Express
🏦 **Transferencia:** SPEI y transferencia directa  
💰 **Billetera Mercora:** Usa tu saldo de ventas
...
"""
            ...
            response += f"""
💡 **Alternativa rápida:** Usa la **Billetera Mercora** si tienes saldo disponible.
...
¿Cuál es el problema específico que tienes con tu pago?"""
    ...
    def _template_refund(self, message: str, context: Dict) -> Tuple[str, int]:
        ...
        response = f"""Información sobre reembolsos en Mercora:

⏱️ **Tiempos de procesamiento:**
• Billetera Mercora: {policies["refund_time_wallet"]}
...
¿Qué configuración específica quieres cambiar?"""
    ...
    def _template_account_delete(self, message: str, context: Dict) -> Tuple[str, int]:
        ...
        response = f"""Para eliminar tu cuenta de Mercora:
...
💡 Puedes marcar una dirección como **predeterminada** para futuras compras."""
            ...
            response = f"""Tiempos de envío en Mercora:
...
💡 En cada producto verás el tiempo estimado para tu ubicación específica."""
            ...
            response = f"""Información de envíos en Mercora:
...
• **Paquetería** - Retrasos externos a Mercora
...
¿Cuál es el problema específico con tu envío?"""
    ...
    def _template_sell_how(self, message: str, context: Dict) -> Tuple[str, int]:
        ...
        response = f"""Para vender en Mercora, sigue estos pasos:
...
1. El pago llega a tu **Billetera Mercora** cuando el comprador confirma recepción
2. Ve a **{nav["wallet"]}**
...
📊 **Comisión de Mercora:** {policies["commission"]} (se descuenta automáticamente)"""
        
        elif "comision" in msg_lower or "porcentaje" in msg_lower:
            response = f"""Comisiones de venta en Mercora:
...
• Acceso a funciones premium"""
            ...
            response = f"""Opciones de seguridad en Mercora:
...
• ¿Qué modelo de teléfono tienes?"""
    ...
    def _template_greeting(self, message: str, context: Dict) -> Tuple[str, int]:
        ...
        response = """¡Hola! 👋 Soy el asistente virtual de Mercora.
