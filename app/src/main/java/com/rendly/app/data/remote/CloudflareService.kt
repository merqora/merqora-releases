...
/**
 * Cloudflare R2 image upload service (S3-compatible API).
 * Used for avatars, banners, highlights and story images.
 */
object CloudflareService {
    ...
    private const val BUCKET_NAME = "merqora-media"
    private const val ACCESS_KEY_ID = "***REMOVED_R2_ACCESS_KEY***"
    private const val SECRET_ACCESS_KEY = "***REMOVED_R2_SECRET***"
    private const val PUBLIC_DOMAIN = "https://pub-cebe8fce90a546d59d5743f71922c3ff.r2.dev"
    // ──────────────────────────────────────────────────────────────────

    private const val ENDPOINT = "$ACCOUNT_ID.r2.cloudflarestorage.com"
    ...
    suspend fun uploadImage(
        ...
        mediaType: com.rendly.app.media.MediaOptimizer.MediaType? = null,
        ...
        try {
            ...
            if (mediaType != null) {
                val result = com.rendly.app.media.MediaOptimizer.optimize(bitmap, mediaType)
