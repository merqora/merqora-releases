package com.vinzay.app.ui.viewmodel
...
import com.vinzay.app.data.remote.MapboxService
import com.vinzay.app.data.repository.AddressRepository
import com.vinzay.app.engine.AddressEngine
    ...
    fun updateAddress(addressId: String, userId: String) {
        viewModelScope.launch {
            ...
            addressRepository.updateAddress(addressId, updates).fold(
                onSuccess = { address ->
                    Log.d(TAG, "✓ Address updated: id=${address.id}")
                    addressRepository.getAddresses(userId).fold(
                        onSuccess = { freshAddresses ->
                            _addresses.value = freshAddresses
                        },
                ...
                onFailure = { error ->
                    Log.e(TAG, "❌ Error updating address: ${error.message}")
                    _uiState.update { it.copy(isSaving = false) }
