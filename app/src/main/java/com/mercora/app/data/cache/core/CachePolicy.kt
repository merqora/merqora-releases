package com.mercora.app.data.cache.core
 ...
 * 
 * Design principles:
 * - Frequently changing data (messages, notifications) â†’ short TTL
 * - Semi-static data (profiles, user info) â†’ medium TTL
 * - Static data (categories, config) â†’ long TTL
 */
