...
class AddressRepository @Inject constructor() {
    ...
    suspend fun createAddress(
        ...
        try {
            ...
            Log.d(TAG, "âœ“ Insert completed successfully")
            ...
            if (result != null) {
                ...
                Log.i(TAG, "âœ“ Address created and decoded: id=${result.id}, score=${enrichedRequest.confidenceScore}")
                Result.success(result)
            } else {
                ...
                if (savedAddress != null) {
                    Log.i(TAG, "âœ“ Address created (reloaded): id=${savedAddress.id}")
