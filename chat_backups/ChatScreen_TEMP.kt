...
// COMPONENTES DE MENSAJE (INTERNAL)
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
private fun MessageBubble(
    ...
    val myBubbleColor = Color(0xFF005C4B) // Verde oscuro WhatsApp
    val otherBubbleColor = Color(0xFF202C33) // Gris oscuro WhatsApp
    ...
    // Extraer datos de media/json si aplica
        ...
        Row(
            ...
            Surface(
                ...
                Column(modifier = Modifier.padding(if (isImage || isVideo || isLocation) 0.dp else 8.dp)) {
                    ...
                    when {
                        ...
                        isLocation && locationData != null -> {
                            ...
                            Box(
                                ...
                                val mapHtml = remember(latStr, lngStr) {
                                    ...
                                    <body>
                                        ...
                                        <script>
                                            ...
                                            // Usar CartoDB Dark Matter para mejor look nocturno nativo
                                ...
                                // Overlay de carga (se oculta tras 2 segundos)
                        ...
                        (isImage || isVideo) && mediaUrl != null -> {
                            val captionBg = Color.Black.copy(alpha = 0.4f)
                            ...
                            Column(modifier = Modifier.width(220.dp)) {
                                Box(
                                    ...
                                    // Imagen centrada - con cache estable para evitar parpadeo
                                    ...
                                    // Gradiente superior para legibilidad del username (solo si hay username)
                    ...
                    // Metadata: Hora y Status (alineados a la derecha del contenido)
                    Row(
                        modifier = Modifier
                            .align(Alignment.End)
